<section>
    <header>
        <div class="flex">
            <h2 class="text-lg font-medium text-gray-900">
                    {{ 'Githubの経験がないであろう人へのコメント付与' }}
                    <br>{{ '論理削除用delete_flagは 0で表示、1で非表示' }}
            </h2>
            <div class="back_btn_area" style="padding:1rem;">
                <a href="{{ route('administrator.nongithub_users_indexview',$post) }}" >
    ...
    <form method="post" action="{{ route('non_github_users_posts.info.update', $post) }}" class="mt-6 space-y-6" >
