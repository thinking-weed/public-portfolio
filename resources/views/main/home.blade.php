...
<html lang="ja">
    ...
    <body class="antialiased" style="background-color: azure;">
        <p class="first_message">
            本HPをご覧いただきありがとうございます。
            <br>※連絡先はメニューのContactのところに記載しております。
            <br>　改善点等ありましたら、レビューをいただけるとありがたいです。
        </p>
        <div class="outerwrap">
                ...
                <div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-13">
                            ...
                            <div class="article">
                                ...
                                <div class="accordion biography" id="accordion_biography">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTwo_biography" class="accordion-collapse" data-bs-parent="#accordion_biography">
                                            <div class="accordion-body">
                            ...
                            <div>
                                ...
                                <div class="accordion myskills" id="accordion_myskills">
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne_myskills" class="accordion-collapse" data-bs-parent="#accordion_myskills">
                                            <div class="accordion-body">
                                                <p class="mt-4 text-black-500 dark:text-white-400 leading-relaxed">
                                                    <div class="learncontents">
                                                        {{ 'HTML / CSS / Javascript  / PHP / MySQL  / Laravel / Github / Slack' }}
                                                    </div>
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTwo_myskills" class="accordion-collapse" data-bs-parent="#accordion_myskills">
                                            <div class="accordion-body">
                                                <p class="mt-4 text-black-500 dark:text-white-400 leading-relaxed">
                                                    <div class="learncontents">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseThree_myskills" class="accordion-collapse" data-bs-parent="#accordion_myskills">
                                            <div class="accordion-body">
                                                <p class="mt-4 text-black-500 dark:text-white-400 leading-relaxed">
                                                    <div class="learncontents">
                                                        <span>{{'Python3 / Vue.js / Typescript / GeoGebra script / Javascript / Laravel / PHP'}}</span>
                                                    </div>
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="article">
                                ...
                                <div class="accordion WorksAtWas" id="accordion_WorksAtWas">
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne_WorksAtWas" class="accordion-collapse" data-bs-parent="#accordion_WorksAtWas">
                                            <div class="accordion-body">
                                                <p class="mt-4 text-black-500 dark:text-white-400 leading-relaxed">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTwo_WorksAtWas" class="accordion-collapse" data-bs-parent="#accordion_WorksAtWas">
                                            <div class="accordion-body">
                                                <p class="mt-4 text-black-500 dark:text-white-400 leading-relaxed">
                        ...
                        <div class="OragaEC_maker scale-100 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl
                         ...
                         <div class="scale-100 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl --}}
                        from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg
                        shadow-2xl shadow-gray-500/20 dark:shadow-none flex
                        motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div class="article">
