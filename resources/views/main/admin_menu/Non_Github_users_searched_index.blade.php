            ...
            <div class="mt-4 p-8 bg-white w-full rounded-2xl">
                ...
                <h2 class="contact_id_at p-4 font-semibold">
                    ...
                    <div class="btn_part flex">
                        <a href="{{ route('ContactForm.showeach',$search_result) }}" class="block">
                            <x-primary-button>
                                個別表示
                            </x-primary-button>
                        </a>
                        <a href="{{ route('non_github_users_posts.editor.view',$search_result->id) }}" class="block">
                            <x-primary-button>
                                編集
                            </x-primary-button>
                        </a>
                        <form action="{{ route('non_github_user_post.destroy', ['id' => $search_result->id]) }}" method="POST" class="block">
                        {{-- itemテーブルのidカラムを取り出す --}}
